...
#define DEFAULT_SSID        "aaa"              // Enter your network SSID
#define DEFAULT_KEY         "xxx"            // Enter your network WPA key
#define DEFAULT_SERVER      "1.1.2.2"       // Enter your Domoticz Server IP address
...
#define DEFAULT_IP          "192.168.2.aaa"      // Enter your IP address
#define DEFAULT_DNS         "192.168.2.bbb"       // Enter your DNS
#define DEFAULT_GW          "192.168.2.ccc"       // Enter your gateway
